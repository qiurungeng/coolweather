...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(final String weatherId){
        String weatherUrl="http://guolin.tech/api/weather?cityid="+weatherId+"&key=" +
                "35fe82b0d9744c42912240b0baae17e1";
    ...
    private void showWeatherInfo(Weather weather){
        ...
        for (Forecast forecast:weather.forecastList){
            ...
            TextView dataTest=(TextView)view.findViewById(R.id.date_text);
            TextView infoText=(TextView)view.findViewById(R.id.info_text);
            TextView maxText=(TextView)view.findViewById(R.id.max_text);
            TextView minText=(TextView)view.findViewById(R.id.min_text);
            dataTest.setText(forecast.date);
            infoText.setText(forecast.more.info);
            maxText.setText(forecast.temprerature.max);
            minText.setText(forecast.temprerature.min);
